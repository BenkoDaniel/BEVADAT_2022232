...
lin_regression = train_linear_regression(X_train, y_train)
log_regression = train_logistic_regression(X_train, y_train)

preds = predict(log_regression, X_test)
...
lin_preds = predict(lin_regression, X_test)
log_preds = predict(log_regression, X_test)

lin_plot = plot_actual_vs_predicted(y_test, lin_preds)
log_plot = plot_actual_vs_predicted(y_test, log_preds)
plt.show()
'''
...
lin_eval = evaluate_model(y_test, lin_preds)
log_eval = evaluate_model(y_test, log_preds)
'''