...
def capitalize_columns(test_df) -> pandas.core.frame.DataFrame:
    new_df_capitalized = test_df.copy()
    colList = []
...
def did_pre_course(test_df) -> pandas.core.frame.DataFrame:
    return test_df[test_df['test preparation course'] == 'completed']
