...
def get_column(test_df, column: str) -> pandas.core.series.Series:
       new_df = test_df.copy()
       return new_df[column]

#print(get_column(df, "country"))
...
def population_density(test_df) -> pandas.core.frame.DataFrame:
       new_df = test_df.copy()
...
def plot_population(test_df: pd.core.frame.DataFrame) -> matplotlib.figure.Figure:
       ...
       ax.set_xlabel("Population of Countries")
